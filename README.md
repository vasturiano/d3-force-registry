...
| [d3.forceMagnetic](https://www.npmjs.com/package/d3-force-magnetic) | Inverse-square (distance) attraction/repulsion force applied to all nodes or dedicated node-pair edges. Useful to simulate natural occurring forces such as gravity or electrostatic. | [d3-force-magnetic](https://github.com/vasturiano/d3-force-magnetic) | <ul><li>[Accretion](https://bl.ocks.org/vasturiano/2da88fb89cc75d18b20d8a7776fd6860)</li><li>[Orbits](https://bl.ocks.org/vasturiano/5086628299fa6c1bae0094f93d112634)</li></ul> |
